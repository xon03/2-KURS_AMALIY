...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"C:/Users/runneradmin/AppData/Local/Temp/build-env-cctthhs7/Scripts/python.exe",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"D:/a/contourpy/contourpy/.mesonpy-_jtf2lq5/lib/contourpy/util",
        source_dir=r"D:/a/contourpy/contourpy/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=mt -Dvsenv=true '-Dcpp_link_args=['ucrt.lib','vcruntime.lib','/nodefaultlib:libucrt.lib','/nodefaultlib:libvcruntime.lib']' '--native-file=D:/a/contourpy/contourpy/.mesonpy-_jtf2lq5/meson-python-native-file.ini'",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
